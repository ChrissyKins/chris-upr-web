// All 251 Gen 2 Pokemon with their national dex numbers
// Names match exactly what the Java randomizer uses
export const POKEMON = [
  ...
  { id: 165, name: "Ledyba" }, { id: 166, name: "Ledian" },
  { id: 167, name: "Spinarak" }, { id: 168, name: "Ariados" },
  { id: 169, name: "Crobat" },
  ...
  { id: 183, name: "Marill" }, { id: 184, name: "Azumarill" },
  ...
  { id: 215, name: "Sneasel" },
  { id: 216, name: "Teddiursa" }, { id: 217, name: "Ursaring" },
  ...
  { id: 228, name: "Houndour" }, { id: 229, name: "Houndoom" },
  { id: 230, name: "Kingdra" },
  { id: 231, name: "Phanpy" }, { id: 232, name: "Donphan" },
  ...
  { id: 249, name: "Lugia" }, { id: 250, name: "Ho-Oh" },
  { id: 251, name: "Celebi" },
];

// Build lookups by name (case-insensitive) and by ID
export const POKEMON_BY_NAME = {};
export const POKEMON_BY_ID = {};
POKEMON.forEach(p => {
  POKEMON_BY_NAME[p.name.toUpperCase()] = p;
  POKEMON_BY_ID[p.id] = p;
});

// Sprite URL helper - uses PokeAPI sprites
export function getSpriteUrl(id) {
  if (!id || id < 1 || id > 251) return null;
